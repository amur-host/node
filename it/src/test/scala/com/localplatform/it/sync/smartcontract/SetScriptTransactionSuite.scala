    ...
    val tx =
      TransferTransactionV2
        .selfSigned(
          ...
          recipient = acc0,
          amount = 3 * transferAmount + 3 * (0.00001.local + 0.00002.local), // Script fee
    ...
    val tx =
      TransferTransactionV2
        .selfSigned(
          ...
          timestamp = System.currentTimeMillis(),
          feeAssetId = None,
          feeAmount = minFee + 0.00001.local + 0.00002.local,
          attachment = Array.emptyByteArray
        )
        .explicitGet()
