...
import com.localplatform.consensus.FairPoSCalculator
import com.localplatform.crypto
import com.localplatform.it.api.AsyncNetworkApi.NodeAsyncNetworkApi
import com.localplatform.it.api.SyncHttpApi._
import com.localplatform.it.transactions.NodesFromDocker
import com.localplatform.it.{NodeConfigs, WaitForHeight2}
...
import com.localplatform.block.{Block, SignerData}
...
class PoSSuite extends FunSuite with Matchers with NodesFromDocker with WaitForHeight2 with CancelAfterFailure {
  ...
  override protected def nodeConfigs: Seq[Config] =
    NodeConfigs.newBuilder
      ...
      .withDefault(3)
      .withSpecial(_.raw("local.miner.enable = yes"))
      .buildNonConflicting()
