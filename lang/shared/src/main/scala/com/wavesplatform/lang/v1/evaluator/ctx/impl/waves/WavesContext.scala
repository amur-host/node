...
import com..lang.v1.compiler.Types.{BYTEVECTOR, LONG, STRING, _}
...
import com..lang.v1.evaluator.ctx.impl.{EnvironmentFunctions, PureContext}
import com..lang.v1.traits._
...
object WavesContext {
  ...
  def build(env: Environment): CTX = {
    ...
    val txByIdF: BaseFunction = {
      val returnType = com..lang.v1.compiler.Types.UNION.create(com..lang.v1.compiler.Types.UNIT +: anyTransactionType.l)
