package com.localplatform.lang.v1.evaluator.ctx.impl.local

import cats.data.EitherT
import cats.implicits._
import com.localplatform.lang.v1.compiler.Terms._
import com.localplatform.lang.v1.compiler.Types.{BYTEVECTOR, LONG, STRING, _}
import com.localplatform.lang.v1.evaluator.FunctionIds._
import com.localplatform.lang.v1.evaluator.ctx._
import com.localplatform.lang.v1.evaluator.ctx.impl.PureContext.fromOption
import com.localplatform.lang.v1.evaluator.ctx.impl.{EnvironmentFunctions, PureContext}
import com.localplatform.lang.v1.traits._
import com.localplatform.lang.v1.traits.domain.Recipient
import com.localplatform.lang.v1.{CTX, FunctionHeader}
...
object LocalContext {
  ...
  def build(env: Environment): CTX = {
    ...
    val txByIdF: BaseFunction = {
      val returnType = com.localplatform.lang.v1.compiler.Types.UNION.create(com.localplatform.lang.v1.compiler.Types.UNIT +: anyTransactionType.l)
    ...
    val localBalanceF: UserFunction = UserFunction("localBalance", LONG, "addressOrAlias" -> addressOrAliasType) {
    ...
    val vars: Map[String, (FINAL, LazyVal)] = Map(
      ("height", (com.localplatform.lang.v1.compiler.Types.LONG, LazyVal(EitherT(heightCoeval)))),
    ...
    CTX(Types.localTypes, vars, functions)
  }
}
