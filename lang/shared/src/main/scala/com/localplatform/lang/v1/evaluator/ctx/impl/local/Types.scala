...
import com.localplatform.lang.v1.evaluator.ctx.{CaseType, UnionType}
...
object Types {
  ...
  val localTypes = Seq(addressType, aliasType, transfer, orderType, assetPairType, dataEntryType, transactionsCommonType) ++ transactionTypes
}
