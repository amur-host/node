package com.localplatform.lang.v1.parser

import com.localplatform.lang.v1.parser.BinaryOperation._
import com.localplatform.lang.v1.parser.Expressions._
import com.localplatform.lang.v1.parser.UnaryOperation._
import fastparse.{WhitespaceApi, core}
import scodec.bits.ByteVector

object Parser {

  private val Global                 = com.localplatform.lang.hacks.Global // Hack for IDEA
  ...
  private val border: P[Unit] = CharIn(" \t\n\r({")
          ...
          accessors.foldLeft(obj) {
            case (e, (accessStart, a, accessEnd)) =>
              a match {
                ...
                case Args(args) =>
                  e match {
                    case REF(_, functionName) => FUNCTION_CALL(Pos(start, accessEnd), functionName, args.toList)
                    case _                       => FUNCTION_CALL(Pos(start, accessEnd), PART.INVALID(Pos(start, objEnd), s"'$obj' is not a function name"), args.toList)
                  }
