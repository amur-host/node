...
import cats.Show
import com.localplatform.generator.NarrowTransactionGenerator.Settings
import com.localplatform.state.DataEntry.{MaxValueSize, Type}
import com.localplatform.state.{BinaryDataEntry, BooleanDataEntry, ByteStr, EitherExt2, IntegerDataEntry, StringDataEntry}
import org.slf4j.LoggerFactory
import com.localplatform.account.{Alias, PrivateKeyAccount}
import com.localplatform.utils.LoggerFacade
...
import com.localplatform.transaction.lease.{LeaseCancelTransaction, LeaseCancelTransactionV1, LeaseTransactionV1}
  ...
  def generate(n: Int): Seq[Transaction] = {
    ...
    val tradeAssetIssue = IssueTransactionV1
      .selfSigned(
        ...
        "TRADE".getBytes,
        "Local DEX is the best exchange ever".getBytes,
        100000000,
        2,
        reissuable = false,
