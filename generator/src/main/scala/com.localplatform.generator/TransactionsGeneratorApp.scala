...
import com.localplatform.generator.cli.ScoptImplicits
import com.localplatform.generator.config.FicusImplicits
import com.localplatform.network.client.NetworkSender
import com.localplatform.settings.inetSocketAddressReader
...
object TransactionsGeneratorApp extends App with ScoptImplicits with FicusImplicits with EnumerationReader {
  ...
  val parser = new OptionParser[GeneratorSettings]("generator") {
    head("TransactionsGenerator - Local load testing transactions generator")
