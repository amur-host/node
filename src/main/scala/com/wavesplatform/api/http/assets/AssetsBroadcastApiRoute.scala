  ...
  @ApiImplicitParams(
    Array(
      new ApiImplicitParam(
        ...
        required = true,
        paramType = "body",
        dataType = "com.amurplatform.api.http.assets.SignedIssueV1Request"
      )))
  @ApiResponses(
    Array(
  ...
  @ApiImplicitParams(
    Array(
      new ApiImplicitParam(
        ...
        required = true,
        paramType = "body",
        dataType = "com.amurplatform.api.http.assets.SignedReissueV1Request"
      )))
  @ApiResponses(
    Array(
  ...
  @ApiImplicitParams(
    Array(
      new ApiImplicitParam(name = "body",
                           ...
                           required = true,
                           paramType = "body",
                           dataType = "com.amurplatform.api.http.assets.SignedBurnV1Request")))
  @ApiResponses(
    Array(
  ...
  @ApiImplicitParams(
    Array(
      new ApiImplicitParam(
        ...
        required = true,
        paramType = "body",
        dataType = "com.amurplatform.api.http.assets.SignedTransferV2Request",
        allowMultiple = true,
        defaultValue =
  ...
  @ApiImplicitParams(
    Array(
      new ApiImplicitParam(
        ...
        required = true,
        paramType = "body",
        dataType = "com.amurplatform.api.http.assets.SignedExchangeRequest"
      )))
  @ApiResponses(
    Array(
