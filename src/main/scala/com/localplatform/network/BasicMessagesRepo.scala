...
import com.localplatform.mining.Miner.MaxTransactionsPerMicroblock
...
import com.localplatform.network.message.Message._
import com.localplatform.network.message._
import com.localplatform.transaction.{Transaction, TransactionParsers}
...
object TransactionSpec extends MessageSpec[Transaction] {
  ...
  // Modeled after Data Transaction https://localplatform.atlassian.net/wiki/spaces/MAIN/pages/119734321/Data+Transaction
