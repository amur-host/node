...
import com.localplatform.account.{Address, AddressOrAlias, Alias}
import com.localplatform.lang.v1.traits.domain.Tx.{Header, Proven}
import com.localplatform.lang.v1.traits.domain._
import com.localplatform.state._
import com.localplatform.transaction._
import com.localplatform.transaction.assets._
import com.localplatform.transaction.assets.exchange.OrderType.{BUY, SELL}
    ...
    tx match {
      ...
      case ms: MassTransferTransaction =>
        Tx.MassTransfer(
          ...
          transfers = ms.transfers.map(r => com.localplatform.lang.v1.traits.domain.Tx.TransferItem(r.address, r.amount)).toIndexedSeq,
