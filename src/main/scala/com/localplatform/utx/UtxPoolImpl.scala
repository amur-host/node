...
import com.localplatform.mining.MultiDimensionalMiningConstraint
import com.localplatform.settings.{FunctionalitySettings, UtxSettings}
import com.localplatform.state.diffs.TransactionDiffer
import com.localplatform.state.reader.CompositeBlockchain.composite
import com.localplatform.state.{Blockchain, ByteStr, Diff, Portfolio}
import kamon.Kamon
...
import com.localplatform.consensus.TransactionsOrdering
import com.localplatform.utils.{ScorexLogging, Time}
import com.localplatform.transaction.ValidationError.{GenericError, SenderIsBlacklisted}
import com.localplatform.transaction._
import com.localplatform.transaction.assets.ReissueTransaction
...
class UtxPoolImpl(time: Time, blockchain: Blockchain, feeCalculator: FeeCalculator, fs: FunctionalitySettings, utxSettings: UtxSettings)
  ...
  import com.localplatform.utx.UtxPoolImpl._
