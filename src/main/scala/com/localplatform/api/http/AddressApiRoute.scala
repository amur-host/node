...
import com.localplatform.consensus.GeneratingBalanceProvider
...
import com.localplatform.transaction.{TransactionFactory, ValidationError}
  ...
  @ApiImplicitParams(
    Array(
      ...
      new ApiImplicitParam(
        ...
        required = true,
        paramType = "body",
        dataType = "com.localplatform.api.http.SignedMessage",
        defaultValue =
  ...
  @ApiImplicitParams(
    Array(
      new ApiImplicitParam(
        ...
        required = true,
        paramType = "body",
        dataType = "com.localplatform.api.http.DataRequest",
