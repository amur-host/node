package com.localplatform.api.http.swagger
...
class SwaggerDocService(val actorSystem: ActorSystem, val materializer: ActorMaterializer, val apiTypes: Seq[Type], settings: RestAPISettings)
  ...
  override val info: Info = Info(
    "The Web Interface to the Local Full Node API",
    Version.VersionString,
    "Local Full Node",
    "License: Apache License, Version 2.0",
    None,
    Some(License("Apache License, Version 2.0", "https://github.com/localplatform/Local/blob/master/LICENSE"))
  )
