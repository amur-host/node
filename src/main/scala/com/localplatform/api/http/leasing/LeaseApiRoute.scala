package com.localplatform.api.http.leasing
...
import com.localplatform.api.http.leasing.LeaseCancelV1Request.leaseCancelRequestFormat
import com.localplatform.api.http.leasing.LeaseV1Request.leaseCancelRequestFormat
import com.localplatform.http.BroadcastRoute
import com.localplatform.utils.Time
import com.localplatform.transaction._
import com.localplatform.transaction.lease.{LeaseTransaction, LeaseTransactionV1}
  ...
  @ApiImplicitParams(
    Array(
      new ApiImplicitParam(
        ...
        required = true,
        paramType = "body",
        dataType = "com.localplatform.api.http.leasing.LeaseV1Request",
        defaultValue =
  ...
  @ApiImplicitParams(
    Array(
      new ApiImplicitParam(
        ...
        required = true,
        paramType = "body",
        dataType = "com.localplatform.api.http.leasing.LeaseCancelV1Request",
        defaultValue =
