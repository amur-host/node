...
import com.localplatform.state.{Blockchain, ByteStr}
...
import com.localplatform.utils.{Base58, Time}
import com.localplatform.transaction.assets.IssueTransaction
import com.localplatform.transaction.assets.exchange.Order
import com.localplatform.transaction.assets.exchange.OrderJson._
import com.localplatform.transaction.smart.script.ScriptCompiler
import com.localplatform.transaction.{AssetIdStringLength, TransactionFactory}
    ...
    (get & path(Segment / "distribution")) { assetId =>
      complete {
        Success(assetId).filter(_.length <= AssetIdStringLength).flatMap(Base58.decode) match {
          ...
          case Failure(_) =>
            ApiError.fromValidationError(com.localplatform.transaction.ValidationError.GenericError("Must be base58-encoded assetId"))
        }
      }
    }
  ...
  @ApiImplicitParams(
    Array(
      new ApiImplicitParam(
        ...
        required = true,
        paramType = "body",
        dataType = "com.localplatform.api.http.assets.TransferV2Request",
        defaultValue =
  ...
  @ApiImplicitParams(
    Array(
      new ApiImplicitParam(
        ...
        required = true,
        paramType = "body",
        dataType = "com.localplatform.api.http.assets.MassTransferRequest",
        defaultValue =
  ...
  @ApiImplicitParams(
    Array(
      new ApiImplicitParam(
        ...
        required = true,
        paramType = "body",
        dataType = "com.localplatform.api.http.assets.IssueV1Request",
        defaultValue =
  ...
  @ApiImplicitParams(
    Array(
      new ApiImplicitParam(
        ...
        required = true,
        paramType = "body",
        dataType = "com.localplatform.api.http.assets.ReissueV1Request",
  ...
  @ApiImplicitParams(
    Array(
      new ApiImplicitParam(
        ...
        required = true,
        paramType = "body",
        dataType = "com.localplatform.api.http.assets.BurnV1Request",
  ...
  @ApiImplicitParams(
    Array(
      new ApiImplicitParam(
        ...
        required = true,
        paramType = "body",
        dataType = "com.localplatform.transaction.assets.exchange.Order"
      )
    ))
  def signOrder: Route =
  ...
  @ApiImplicitParams(
    Array(
      new ApiImplicitParam(
        ...
        required = true,
        paramType = "body",
        dataType = "com.localplatform.api.http.assets.SponsorFeeRequest",
