...
import com.localplatform.transaction.{Transaction, ValidationError}
  ...
  @ApiImplicitParams(
    Array(
      new ApiImplicitParam(
        ...
        required = true,
        paramType = "body",
        dataType = "com.localplatform.api.http.assets.SignedIssueV1Request"
      )))
  @ApiResponses(
    Array(
  ...
  @ApiImplicitParams(
    Array(
      new ApiImplicitParam(
        ...
        required = true,
        paramType = "body",
        dataType = "com.localplatform.api.http.assets.SignedReissueV1Request"
      )))
  @ApiResponses(
    Array(
  ...
  @ApiImplicitParams(
    Array(
      new ApiImplicitParam(name = "body",
                           ...
                           required = true,
                           paramType = "body",
                           dataType = "com.localplatform.api.http.assets.SignedBurnV1Request")))
  @ApiResponses(
    Array(
  ...
  @ApiImplicitParams(
    Array(
      new ApiImplicitParam(
        ...
        required = true,
        paramType = "body",
        dataType = "com.localplatform.api.http.assets.SignedTransferV2Request",
        allowMultiple = true,
        defaultValue =
  ...
  @ApiImplicitParams(
    Array(
      new ApiImplicitParam(
        ...
        required = true,
        paramType = "body",
        dataType = "com.localplatform.api.http.assets.SignedExchangeRequest"
      )))
  @ApiResponses(
    Array(
