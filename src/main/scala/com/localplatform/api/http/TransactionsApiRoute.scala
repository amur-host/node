...
import com.localplatform.account.{Address, PublicKeyAccount}
import com.localplatform.api.http.DataRequest._
import com.localplatform.api.http.alias.{CreateAliasV1Request, CreateAliasV2Request, SignedCreateAliasV1Request, SignedCreateAliasV2Request}
import com.localplatform.api.http.assets.SponsorFeeRequest._
import com.localplatform.api.http.assets._
import com.localplatform.api.http.leasing._
import com.localplatform.http.BroadcastRoute
import com.localplatform.settings.{FunctionalitySettings, RestAPISettings}
import com.localplatform.state.diffs.CommonValidation
  ...
  private def txToExtendedJson(tx: Transaction): JsObject = {
    ...
    tx match {
      case lease: LeaseTransaction =>
        import com.localplatform.transaction.lease.LeaseTransaction.Status._
