package com.localplatform.matcher.api
...
import com.localplatform.matcher.market.MatcherActor.{GetMarkets, GetMarketsResponse}
import com.localplatform.matcher.market.MatcherTransactionWriter.GetTransactionsByOrder
...
class MatcherApiRoute(wallet: Wallet,
  ...
  @ApiImplicitParams(
    Array(
      new ApiImplicitParam(name = "amountAsset", value = "Amount Asset Id in Pair, or 'LOCAL'", dataType = "string", paramType = "path"),
      new ApiImplicitParam(name = "priceAsset", value = "Price Asset Id in Pair, or 'LOCAL'", dataType = "string", paramType = "path"),
  ...
  @ApiImplicitParams(
    Array(
      new ApiImplicitParam(
        ...
        required = true,
        paramType = "body",
        dataType = "com.localplatform.matcher.api.CancelOrderRequest"
      )
    ))
