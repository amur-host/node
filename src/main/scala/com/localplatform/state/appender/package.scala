...
import com.localplatform.consensus.{GeneratingBalanceProvider, PoSSelector, TransactionsOrdering}
import com.localplatform.mining._
import com.localplatform.network._
import com.localplatform.settings.{FunctionalitySettings, LocalSettings}
import com.localplatform.utx.UtxPool
import io.netty.channel.Channel
import io.netty.channel.group.ChannelGroup
import monix.eval.Task
import com.localplatform.block.Block
import com.localplatform.transaction.ValidationError.{BlockAppendError, BlockFromFuture, GenericError}
...
package object appender extends ScorexLogging {
  ...
  private[appender] def appendBlock(checkpoint: CheckpointService,
                                    ...
                                    pos: PoSSelector,
                                    time: Time,
                                    settings: LocalSettings)(block: Block): Either[ValidationError, Option[Int]] =
    for {
      _ <- Either.cond(
  ...
  private def blockConsensusValidation(blockchain: Blockchain, settings: LocalSettings, pos: PoSSelector, currentTs: Long, block: Block)(
