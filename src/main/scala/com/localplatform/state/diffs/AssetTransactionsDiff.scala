...
import com.localplatform.state.{AssetInfo, Blockchain, Diff, LeaseBalance, Portfolio, SponsorshipValue}
...
import com.localplatform.transaction.{AssetId, ProvenTransaction, ValidationError}
