...
import com.localplatform.transaction.ValidationError.OrderValidationError
import com.localplatform.transaction.assets.exchange.{Order, _}
...
class ExchangeTransactionSpecification extends PropSpec with PropertyChecks with Matchers with TransactionGen {
  ...
  property("JSON format validation") {
    ...
    val buy = OrderV1(
      ...
      AssetPair.createAssetPair("LOCAL", "9ZDWzK53XT5bixkmMwTJi2YzgxCqn5dUajXFcT2HcFDy").get,
      OrderType.BUY,
      6000000000L,
      2,
      1526992336241L,
