...
import com.localplatform.transaction.{CreateAliasTransaction, CreateAliasTransactionV1, GenesisTransaction}
...
class CreateAliasTransactionDiffTest extends PropSpec with PropertyChecks with Matchers with TransactionGen with NoShrink {
  ...
  property("can create and resolve aliases preserving local invariant") {
