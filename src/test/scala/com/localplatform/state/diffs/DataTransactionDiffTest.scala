...
import com.localplatform.state.{BinaryDataEntry, BooleanDataEntry, ByteStr, DataEntry, EitherExt2, IntegerDataEntry}
...
import com.localplatform.transaction.{DataTransaction, GenesisTransaction}
